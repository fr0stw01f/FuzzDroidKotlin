...
class CodePositionManager private constructor()
{
    ...
    fun getMethodOffset(methodSignature: String): Int {
        var offset: Int? = this.methodToOffset[methodSignature]
        if (offset == null) {
    ...
    val methodsWithCodePositions: Set<String>
    ...
    companion object {
        ...
        var codePositionManagerInstance: CodePositionManager? = null
            get() {
