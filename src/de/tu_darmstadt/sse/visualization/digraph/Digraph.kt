...
class Digraph {
    private val subgraphs = HashMap<Subgraph, MutableList<Subgraph>>()
    private val connections = HashMap<String, MutableList<String>>()
    private val methodSignatureToShortName = HashMap<String, String>()
