...
object UtilInstrumenter {
    ...
    val JAVA_CLASS_FOR_PATH_INSTRUMENTATION = "de.tu_darmstadt.sse.additionalappclasses.tracing.BytecodeLogger"
    val JAVA_CLASS_FOR_CODE_POSITIONS = "de.tu_darmstadt.sse.additionalappclasses.tracing.BytecodeLogger"
    val JAVA_CLASS_FOR_CRASH_REPORTING = "de.tu_darmstadt.sse.additionalappclasses.crashreporter.CrashReporter"
    val JAVA_CLASS_FOR_PATH_EXECUTION = "de.tu_darmstadt.sse.additionalappclasses.pathexecution.PathExecutor"

    val ROOT_PACKAGE_OF_INSTRUMENTED_CODE = "de.tu_darmstadt.sse."
    val PACKAGE_FOR_HOOKER = "com.morgoo.hook."

    val HELPER_APPLICATION_FOR_HOOKING = "de.tu_darmstadt.sse.additionalappclasses.HookingHelperApplication"
    val HELPER_SERVICE_FOR_PATH_TRACKING = "de.tu_darmstadt.sse.additionalappclasses.tracing.TracingService"
    val COMPONENT_CALLER_SERVICE_HELPER = "de.tu_darmstadt.sse.additionalappclasses.ComponentCallerService"
    val HOOKER_CLASS = "de.tu_darmstadt.sse.additionalappclasses.hooking.Hooker"
    ...
    val SOOT_OUTPUT = "./sootOutput"
    val SOOT_OUTPUT_APK = UtilInstrumenter.SOOT_OUTPUT + File.separator + File(FrameworkOptions.apkName).getName() + ".apk"
    val SOOT_OUTPUT_DEPLOYED_APK = UtilInstrumenter.SOOT_OUTPUT + File.separator + File(FrameworkOptions.apkName).getName() + "_deployed.apk"
    ...
    fun makeJimpleStaticCallForPathExecution(methodName: String, vararg args: Any): Unit {
        val sootClass = Scene.v().getSootClass(UtilInstrumenter.JAVA_CLASS_FOR_PATH_EXECUTION)
