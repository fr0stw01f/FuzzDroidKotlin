                ...
                if (curAssignStmt.rightOp is InstanceFieldRef) {
                    ...
                    if (mSig == "<android.content.pm.PackageManager: android.content.pm.PackageInfo getPackageInfo(java.lang.String,int)>") {
                        if (invokeExpr is VirtualInvokeExpr) {
                            val vie = invokeExpr
                            val dummyMethod = Scene.v().getMethod("<de.tu_darmstadt.sse.additionalappclasses.wrapper.DummyWrapper: android.content.pm.PackageInfo dummyWrapper_getPackageInfo(android.content.pm.PackageManager,java.lang.String,int)>")
                        ...
                        if (invokeExpr is VirtualInvokeExpr) {
                            val vie = invokeExpr
                            val dummyMethod = Scene.v().getMethod("<de.tu_darmstadt.sse.additionalappclasses.wrapper.DummyWrapper: java.lang.String dummyWrapper_getProperty(java.util.Properties,java.lang.String,java.lang.String)>")
                            val newInv = Jimple.v().newStaticInvokeExpr(dummyMethod.makeRef(), vie.base, vie.getArg(0), vie.getArg(1))
                            curAssignStmt.rightOp = newInv
                        }
                        ...
                        if (invokeExpr is VirtualInvokeExpr) {
                            val vie = invokeExpr
                            val dummyMethod = Scene.v().getMethod("<de.tu_darmstadt.sse.additionalappclasses.wrapper.DummyWrapper: java.lang.String dummyWrapper_getProperty(java.util.Properties,java.lang.String)>")
                        ...
                        if (invokeExpr is VirtualInvokeExpr) {
                            val vie = invokeExpr
                            val dummyMethod = Scene.v().getMethod("<de.tu_darmstadt.sse.additionalappclasses.wrapper.DummyWrapper: java.lang.Class dummyWrapper_loadClass(java.lang.String,java.lang.ClassLoader)>")
                        ...
                        if (invokeExpr is VirtualInvokeExpr) {
                            val vie = invokeExpr
                            val dummyMethod = Scene.v().getMethod("<de.tu_darmstadt.sse.additionalappclasses.wrapper.DummyWrapper: java.lang.reflect.Method dummyWrapper_getMethod(java.lang.Class,java.lang.String,java.lang.Class[])>")
                            val newInv = Jimple.v().newStaticInvokeExpr(dummyMethod.makeRef(), vie.base, vie.getArg(0), vie.getArg(1))
                            curAssignStmt.rightOp = newInv
                        }
