...
class SimpleBooleanAnalysis : FuzzyAnalysis() {
    ...
    override fun resolveRequest(clientRequest: DecisionRequest,
        ...
        if (clientRequest.loggingPointSignature == "<android.app.SharedPreferencesImpl: boolean getBoolean(java.lang.String, boolean)>" || clientRequest.loggingPointSignature == "<android.app.admin.DevicePolicyManager: boolean isAdminActive(android.content.ComponentName)>") {
