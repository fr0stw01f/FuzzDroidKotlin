...
import de.tu_darmstadt.sse.sharedclasses.tracing.*
            ...
            try {
                ...
                while (ois != null && !socket.isClosed) {
                    ...
                    if (clientRequest is TraceItem) {
                        ...
                        if (manager != null) {
                            val currentClientHistory = manager.newestClientHistory
                            if (currentClientHistory != null) {
                                ...
                                for (metric in decisionMaker.config.metrics) {
...
//there will be a hook in the dalvik part
    ...
    private fun handlePathTracking(pathTrackigTrace: PathTrackingTraceItem) {
        ...
        if (mgr != null) {
            val currentClientHistory = mgr.newestClientHistory
