...
class ThreadTraceManager(val threadID: Long) {
    ...
    internal val shadowHistories = ArrayList<ClientHistory>()
    ...
    val histories: List<ClientHistory>
        get() = this.clientHistories


    val newestClientHistory: ClientHistory?
        get() {
    ...
    val lastClientHistory: ClientHistory?
        get() {
